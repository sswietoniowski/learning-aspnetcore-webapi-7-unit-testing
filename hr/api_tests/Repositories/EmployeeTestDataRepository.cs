...
namespace Hr.Api.Tests.Repositories;

public class HrTestDataRepository : IHrRepository
{
    private List<InternalEmployee> _internalEmployees;
    private List<ExternalEmployee> _externalEmployees;
    private List<Course> _courses;

    public HrTestDataRepository()
    {
    ...
    {
        return Task.FromResult(GetCourseById(courseId));
    }
    ...
    public Task<List<Course>> GetCoursesByIdsAsync(params Guid[] courseIds)
    {
        return Task.FromResult(GetCoursesByIds(courseIds));
    }
    ...
    {
        return Task.FromResult(GetInternalEmployeeById(employeeId));
    }
