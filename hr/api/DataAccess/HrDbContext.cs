...
{
    public DbSet<InternalEmployee> InternalEmployees => Set<InternalEmployee>();
    public DbSet<ExternalEmployee> ExternalEmployees => Set<ExternalEmployee>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InternalEmployee>()
            .HasData(
                ...
                new InternalEmployee("Jimmy", "Johnson", 3, 3400, true, 1)
                {
                    Id = Guid.Parse("f484ad8f-78fd-46d1-9f87-bbb1e676e37f") 
                });

        // Many-to-many relationship between InternalEmployee and Course
        modelBuilder
