...
namespace Hr.Api.DataAccess.Migrations
{
    /// <inheritdoc />
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "FirstName", "JobLevel", "LastName", "MinimumRaiseGiven", "Salary", "YearsOfService" },
                values: new object[,]
                {
                    { new Guid("72f2f5fe-e50c-4966-8420-d50258aefdcb"), "Megan", 2, "Jones", false, 3000m, 2 },
                    { new Guid("f484ad8f-78fd-46d1-9f87-bbb1e676e37f"), "Jimmy", 1, "Johnson", true, 3400m, 3 }
                });
