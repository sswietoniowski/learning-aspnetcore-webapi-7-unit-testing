...
namespace Hr.Api.DataAccess.Migrations
{
    ...
    [Migration("20230319112912_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hr.Api.DataAccess.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Hr.Api.DataAccess.Entities.ExternalEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Hr.Api.DataAccess.Entities.InternalEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CourseInternalEmployee", b =>
                {
                    b.HasOne("Hr.Api.DataAccess.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("AttendedCoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hr.Api.DataAccess.Entities.InternalEmployee", null)
                        .WithMany()
